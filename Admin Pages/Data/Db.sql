...
insert into Rescues (Animal,Name,Gender,Age,Sterile,Vac_status,Status,rescued_Date) VALUES ('Cat','CatA','Male',NULL,'Yes','Yes','Adoption',NULL);
insert into Rescues (Animal,Name,Gender,Age,Sterile,Vac_status,Status,rescued_Date) VALUES ('Cat','CatB','Male',NULL,'Yes','Yes','Foster',NULL);
insert into Rescues (Animal,Name,Gender,Age,Sterile,Vac_status,Status,rescued_Date) VALUES ('Cat','CatC','Male',NULL,'Yes','Yes','Sponsor',NULL);
